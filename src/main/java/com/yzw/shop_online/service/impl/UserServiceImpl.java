...
import com.yzw.shop_online.common.convert.UserConvert;
import com.yzw.shop_online.common.exception.ServerException;
import com.yzw.shop_online.common.utils.AliyunResource;
import com.yzw.shop_online.common.utils.FileResource;
import com.yzw.shop_online.common.utils.GeneratorCodeUtils;
import com.yzw.shop_online.common.utils.JWTUtils;
...
import static com.yzw.shop_online.common.constant.APIConstant.*;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public String editUserAvatar(Integer userId, MultipartFile file) {
        ...
        User user = baseMapper.selectById(userId);
        if (user==null){
            throw new ServerException("用户不不存在");
        }
